...
class PageTest:
    ...
    def show_layout(self):
        ...
        self.grid = Grid('grid', 'My Table', self.g_column_coll, row_collection=self.g_record_coll, toolbar=True,
                         footer=True, line_numbers=True, select_column=True, multi_select=True)
